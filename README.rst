...
django-twoscoops-project, run the following command::
    ...
    $ django-admin.py startproject --template=https://github.com/alfetopito/django-project-template/archive/master.zip --extension=py,rst,html --name=Vagrantfile whatever
